...
const updateUser = asyncHandler(async (req, res) => {
  try {
    ...
    const { name, email, password ,state,country,address } = req.body;
...
module.exports = { getUser, getUserById,loginUser, updateUser, registerUser, deleteUser };
